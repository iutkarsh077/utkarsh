...
const myDevicesDesktop: BluetoothDevice[] = [
  { name: "Utkarsh's Magic Keyboard", connected: true, battery: 91, type: "keyboard" },
  { name: "Utkarsh's Magic Trackpad", connected: true, battery: 20, type: "trackpad" },
  { name: "Nothing Headphones", connected: false, type: "headphones" },
  { name: "Utkarsh's AirPods Max", connected: false, type: "airpods-max" },
  { name: "Utkarsh's AirPods Pro", connected: false, type: "airpods" },
      ...
      {bluetoothEnabled && (
        <>
          ...
          <p className="text-xs text-muted-foreground py-4 border-b border-border/50">
            This Mac is discoverable as &quot;Utkarsh&apos;s MacBook Air&quot; while Bluetooth Settings is open.
          </p>
