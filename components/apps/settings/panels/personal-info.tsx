...
const devices: Device[] = [
  { name: "Utkarsh's MacBook Air", model: "This MacBook Air", type: "macbook" },
  { name: "Utkarsh's iPhone", model: "iPhone", type: "iphone" },
  { name: "Utkarsh's iPad", model: "iPad Air", type: "ipad" },
        ...
        <div className="divide-y divide-border/50">
          ...
          >
            ...
            <div className="flex items-center gap-1 text-muted-foreground">
              <span className="text-xs">Utkarsh Singh</span>
