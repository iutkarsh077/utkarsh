...
const appleAccountKeywords = ["utkarsh", "singh", "apple", "account", "personal", "information", "name", "birthday"];
            ...
            <div className="w-[320px] px-2">
              ...
              {showAppleAccount && (
                <div className="py-2">
                  ...
                  >
                    <Image
                      src="https://res.cloudinary.com/dakddv1pm/image/upload/v1771603459/posts/lfrj0rpsgxob5cfiobmr.png"
                      alt="Utkarsh Singh"
                      width={48}
                      height={48}
                    ...
                    <div className="text-left">
                      <div className="font-medium text-xs">Utkarsh Singh</div>
