  ...
  return (
    <div className="fixed top-10 right-4 z-[120] pointer-events-none">
      <button
        ...
        className={`group relative pointer-events-auto w-[390px] max-w-[calc(100vw-24px)] rounded-2xl border border-black/10 dark:border-white/20 bg-[#f3f3f5]/96 dark:bg-zinc-800/96 backdrop-blur-xl shadow-[0_8px_24px_rgba(0,0,0,0.26)] px-4 py-2.5 text-left transition-all duration-300 ${isVisible ? "translate-x-0 opacity-100" : "translate-x-[120%] opacity-0"
          }`}
      >
        <span
          onMouseDown={suppressPointerEvent}
